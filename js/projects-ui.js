...
const ACCESSIBLE_API =
"https://api.buildskil.com/api/projects/accessible";
...
function updateProjectDropdown() {
  ...
  showToast(`Image "${file.name}" is too large (max 2MB)`, "error");
  return;
}
...
await fetch(
  ...
  `Uploaded on: ${new Date(media.timestamp).toLocaleString()}`;
  }

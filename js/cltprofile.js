const REQUIREMENTS = [
  { key: "contractor", label: "Contractor", icon: "hard-hat",
    roles: ["Structural contractor","Masonry contractor", "Civil contractor","Lohaar contractor","Painter contractor","BlackSmith contractor", "Carpentry contractor", "Electrical contractor", "Plumbing contractor", "Interior fit-out contractor"] },
  { key: "supplier", label: "Supplier", icon: "truck",
    roles: ["Material supplier", "Cement supplier","Bricks supplier", "Wood supplier", "Steel & rebar supplier", "Sand & aggregate supplier", "Equipment supplier", "Tiles & sanitaryware supplier"] },
  ...
  { key: "technician", label: "Technician", icon: "user",
    roles: ["Equipment technician", "HVAC technician", "Carpentry technician", "Electrician technician","Solar technician","Demolition technician", "Masnory techncian","Painter technician",  "Machinery operator", "Maintenance technician"] },
